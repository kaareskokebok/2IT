...
print(personer[0]["firstname"])

# Legge til ny person
ny_pers = {}
fornavn, etternavn, alder = "jens", "jensern", 19
ny_pers["firstname"] = fornavn
ny_pers["lastname"] = etternavn
ny_pers["age"] = alder

# Slette en bestem person, etter telefonnr
mobilnr = "44026729"
slettet = False
print(len(personer))

for person in personer:
    if person["mobile"] == mobilnr:
        # Funnet personen
        personer.remove(person)
        slettet = True

if slettet:
    print("Personen ble slettet")
    
else:
    print(f"Ingen person funnet med mobil {mobilnr}")
